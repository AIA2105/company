...
-- Dumping data for table company.order: ~8 rows (approximately)
DELETE FROM `order`;
...
-- Dumping data for table company.product: ~13 rows (approximately)
DELETE FROM `product`;
...
-- Dumping data for table company.supplier: ~5 rows (approximately)
